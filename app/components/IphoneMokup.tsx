        ...
        <div className="relative">
          ...
          <div className="h-128 w-64 bg-slate-500 rounded-[2rem] p-1 overflow-hidden">
            <div className="h-full w-full bg-black rounded-[2rem] overflow-hidden p-2 relative">
              <div className="w-28 h-6 bg-black absolute left-1/2 rounded-b-2xl transform -translate-x-1/2 z-50"></div>
              <div className="h-full w-full rounded-3xl bg-white bg-center bg-cover wallpaper realative">
